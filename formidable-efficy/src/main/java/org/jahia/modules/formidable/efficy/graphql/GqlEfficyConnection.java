...
/** A declared Efficy connection as seen by the editor. */
@GraphQLName("FormidableEfficyConnection")
public class GqlEfficyConnection {
    ...
    public GqlEfficyConnection(String id, String label, boolean ready, String error) {
        this.id = id;
        this.label = label;
        this.ready = ready;
        this.error = error;
