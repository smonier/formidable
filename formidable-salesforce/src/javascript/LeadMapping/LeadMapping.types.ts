/**
 * Where a mapped Salesforce field takes its value from: a form field of the
 ...
 * Java side (fieldMapping property of fmdbsfdc:createLeadAction) — keep it exact.
...
/** A Lead field as described by the formidableSalesforce.objectFields GraphQL query. */
