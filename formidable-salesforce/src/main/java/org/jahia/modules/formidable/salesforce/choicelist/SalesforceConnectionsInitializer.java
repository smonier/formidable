package org.jahia.modules.formidable.salesforce.choicelist;
...
/**
 * Feeds {@code connectionId (string, choicelist[formidableSfdcConnections])} on the action node
...
public class SalesforceConnectionsInitializer implements ModuleChoiceListInitializer {

    public static final String KEY = "formidableSfdcConnections";
    private static final Logger log = LoggerFactory.getLogger(SalesforceConnectionsInitializer.class);
    ...
    public List<ChoiceListValue> getChoiceListValues(ExtendedPropertyDefinition epd, String param,
        ...
        List<SalesforceConnection> connections = registry.all();
        if (connections.isEmpty()) {
            log.warn("[formidable-salesforce] No Salesforce connection is configured "
                    + "(org.jahia.modules.formidable.salesforce-<id>.cfg); the '{}' choice list is empty.", KEY);
        }
